    ...
    return (
      ...
      >
        ...
        <span className="absolute inset-0 overflow-hidden rounded-full">
          <span className="absolute inset-[-100%] animate-[shimmer-spin_4s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,hsl(var(--muted-foreground)/0.1)_0%,hsl(var(--muted-foreground)/0.6)_10%,hsl(var(--muted-foreground)/0.1)_20%)]" />
        </span>
