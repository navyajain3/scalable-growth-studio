        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="opacity-0 animate-slide-up text-center lg:text-left" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-violet-500/10 to-purple-500/10 border border-violet-500/20 flex items-center justify-center group-hover:from-violet-500/20 group-hover:to-purple-500/20 transition-colors">
