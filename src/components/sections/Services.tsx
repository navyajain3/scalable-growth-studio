...
const services = [
  {
    ...
    description: "Custom websites, web apps, and mobile applications built for performance and scale. We use modern technologies to create fast, secure, and scalable digital products.",
  ...
  },
  {
    badge: "Design",
    title: "UI/UX Design",
    description: "User-centered design that creates intuitive, engaging digital experiences. Every pixel is crafted to delight users and drive conversions.",
  ...
  },
  {
    ...
    description: "Strategic brand identity and marketing campaigns that build lasting recognition. We help you stand out in crowded markets with distinctive visual identities.",
  ...
  },
  {
    ...
    description: "Compelling copy and content that resonates with your audience and drives action. From website copy to blog posts, we craft words that convert.",
  ...
  },
  {
    ...
    description: "Professional video content that tells your story and engages your audience. From concept to final cut, we handle every aspect of video creation.",
